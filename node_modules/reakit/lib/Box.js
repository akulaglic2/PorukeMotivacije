...
var BoxComponent = React.forwardRef(function (_ref, ref) {
  ...
  if (typeof T === "string") {
    ...
    return React.createElement(T, __chunk_1._objectSpread({}, allProps, {
      ref: applyAllRefs(ref, props.elementRef)
    }));
  }

  return React.createElement(T, __chunk_1._objectSpread({}, props, {
    ref: applyAllRefs(ref, props.elementRef),
    style: style
  }));
});
var positions = ["static", "absolute", "fixed", "relative", "sticky"];
var Box = styled$1.default(BoxComponent)(_templateObject(), __chunk_3.bgColorWithProps, __chunk_3.textColorWithProps, styledTools.theme("Box"), __chunk_3.bool("position", positions));
var useTypes = [PropTypes.func, PropTypes.string, PropTypes.object]; // @ts-ignore

Box.propTypes = {
  use: PropTypes.oneOfType([].concat(useTypes, [PropTypes.arrayOf(PropTypes.oneOfType(useTypes))])),
...
var Box$1 = use$1.default(Box, "div");
